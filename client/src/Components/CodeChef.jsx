  ...
  return (
    <div className="mt-20">
      <div className="flex justify-center items-center mt-4 mb-7">
        <h2 className="text-white font-extrabold text-3xl">CodeChef Profile Data</h2>
      </div>

      <div className="flex justify-center items-center mx-8 gap-4 space-x-2"> {/* Reduced space between items */}

        {/* Profile Card */}
        <div className="flex flex-row items-center p-4 w-72 h-40 border-2 border-gray-300 rounded-lg shadow-lg animate-border-move">
