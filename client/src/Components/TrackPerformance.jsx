    ...
    <div className="w-full h-[400px]  relative flex justify-center items-center ">
      ...
      <div className="relative h-[90%] w-[90%] bg-gray-400 rounded-lg shadow-md flex items-center justify-center gap-16 transform transition-transform duration-500 hover:-rotate-2 z-10">
        <div className="flex flex-col gap-14">
          <div className="text-black text-5xl font-bold text-center"> Track Your Performance </div> {/* Increased size */}
          <div className="text-black text-2xl font-medium text-center"> Stay updated with the latest performance metrics of various coding platforms. </div> {/* Increased size */}
        </div>
